...
function EmployeesPage() {
  ...
  const fetchEmployees = async () => {
    const res = await axios.get("https://smartdine-pro-smart-restaurant.onrender.com/api/employees/employees/");
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingId) {
      await axios.put(
        `https://smartdine-pro-smart-restaurant.onrender.com/api/employees/employees/${editingId}/`,
        formData
      );
      alert("Employee updated successfully");
    } else {
      await axios.post(
        "https://smartdine-pro-smart-restaurant.onrender.com/api/employees/employees/",
        formData
      );
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Delete this employee?")) {
      await axios.delete(`https://smartdine-pro-smart-restaurant.onrender.com/api/employees/employees/${id}/`);
