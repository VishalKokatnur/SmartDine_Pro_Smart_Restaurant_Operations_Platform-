...
function OrdersPage() {
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get(
        "https://smartdine-pro-smart-restaurant.onrender.com/api/restaurant/orders/"
      );
  ...
  const fetchTables = async () => {
    try {
      const response = await axios.get(
        "https://smartdine-pro-smart-restaurant.onrender.com/api/restaurant/tables/"
      );
  ...
  const fetchMenuItems = async () => {
    try {
      const response = await axios.get(
        "https://smartdine-pro-smart-restaurant.onrender.com/api/restaurant/menu-items/"
      );
  ...
  const checkMenuItemStock = async (menuItemId) => {
    try {
      const response = await axios.post(
        "https://smartdine-pro-smart-restaurant.onrender.com/api/inventory/check-stock/",
        {
  ...
  const saveOrder = async () => {
    ...
    try {
      ...
      if (editingId) {
        await axios.patch(
          `https://smartdine-pro-smart-restaurant.onrender.com/api/restaurant/orders/${editingId}/`,
          payload
        );
  ...
  const handleDelete = async (order) => {
    ...
    try {
      await axios.delete(
        `https://smartdine-pro-smart-restaurant.onrender.com/api/restaurant/orders/${order.id}/`
      );
  ...
  const markOrderServed = async (orderId) => {
    try {
      await axios.patch(
        `https://smartdine-pro-smart-restaurant.onrender.com/api/restaurant/orders/${orderId}/`,
        {
          status: "Served",
        }
      );
