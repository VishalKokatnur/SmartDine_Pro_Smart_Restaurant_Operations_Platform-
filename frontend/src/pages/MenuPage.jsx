...
function MenuPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingId) {
      await axios.put(
        `https://smartdine-pro-smart-restaurant.onrender.com/api/restaurant/menu-items/${editingId}/`,
        formData
      );
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this menu item?")) {
      await axios.delete(
        `https://smartdine-pro-smart-restaurant.onrender.com/api/restaurant/menu-items/${id}/`
      );
